...
def get_max_download_dataset(
    pairing: Dict[str, Any], min_downloads: int = 100
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract unique perfect fuzzy matched model-dataset pairs, keeping highest downloads for duplicate names"
    )
    parser.add_argument(
        "-i", "--input", default="output/metric_pairings.json", help="Input file path"
    )
    parser.add_argument(
        "-o",
        "--output",
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="Minimum downloads threshold for models and datasets (default: 100)",
    )

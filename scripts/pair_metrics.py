...
def process_single_model(model_id: str, readmes_dir: str, metric_collector: MetricCollector) -> Tuple[str, List[Dict[str, Any]]]:
...
def main():
    ...
    print(f"   - Found {len(results['unmatched_dataset_names'])} dataset names that could not be matched.")

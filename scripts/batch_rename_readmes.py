...
def main():
    parser = argparse.ArgumentParser(description='Batch rename README files from xxx_README.md to xxx.md')
    parser.add_argument('--directory', '-d', type=str, default='./output/datasets/readmes/',

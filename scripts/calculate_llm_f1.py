...
def main():
    parser = argparse.ArgumentParser(
        description="Calculate F1 and other metrics for LLM binary predictions"
    )
    parser.add_argument(
        "--input",
        "-i",
        type=str,
        default="./output/llm_binary_predictions_neighborhood.json",
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        default="./output/evaluation_binary",
    ...
    if args.save_metrics:
        ...
        save_metrics_to_file(
            metrics, os.path.join(args.output_dir, "binary_evaluation_metrics.json")
        )

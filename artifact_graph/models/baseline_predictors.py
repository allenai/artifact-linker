...
class DownloadBasedLinkPredictor:
    """
    ...
    def predict(
        ...
        for model_name, dataset_name in edge_pairs:
            try:
                ...
                result = {"prediction": prediction, "reason": reason, "downloads": downloads}
    ...
    def rank_edges_by_attribute(
        ...
        try:
            ...
            if edges_with_downloads:
                ...
                download_range = (
                    max_downloads - min_downloads if max_downloads > min_downloads else 1
                )
            else:
            ...
            return {
                ...
                "download_stats": {
                    ...
                    "avg_downloads": sum(downloads for _, _, downloads in edges_with_downloads)
                    / len(edges_with_downloads)
                    if edges_with_downloads
                    else 0,
                },
            }

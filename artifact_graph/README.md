...
│   │   ├── model_collector.py      # Model information collection
│   │   ├── dataset_collector.py    # Dataset information collection
│   │   └── accuracy_collector.py   # Accuracy information collection
...
#### AccuracyCollector
- **Function**: Collect model-dataset accuracy information
- **Main methods**:
  - `collect_model_dataset_accuracies()`: Collect accuracy data
...
accuracy_collector = AccuracyCollector("path/to/data")
...
```bash
python artifact_graph/scripts/data_collection.py \
...
```python
from artifact_graph.data import build_bipartite_graph, nx_to_pyg_data, prepare_link_pred_splits
...
1. Create new collector class in `data/collectors/` directory
2. Implement necessary methods
3. Export in `data/collectors/__init__.py`

### Adding New Data Processors

1. Create new processor class in `data/processors/` directory
2. Implement necessary methods
3. Export in `data/processors/__init__.py`
